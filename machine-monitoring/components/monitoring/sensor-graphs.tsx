...
export default function SensorGraphs({ machineId }: { machineId: number }) {
  ...
  return (
    <div>
      ...
      {currentValues && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card>
            ...
            <CardContent className="py-2">
              <div className="text-2xl font-bold">{currentValues.vibration.toFixed(2)}</div>
            </CardContent>
          </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="h-64">
          <Line options={chartOptions} data={loadData} />
        </div>
        <div className="h-64">
